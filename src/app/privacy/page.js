...
export default function Privacy() {
    return (
        <Fragment>
            <Box paddingX={2}>
                <Typography variant='h3' color='white' marginBottom={4} textAlign={'center'}>
                    Privacy Policy
                </Typography>
                ...
                <Box marginX={2}>
                    <Typography variant='body' color='white'>
                        If you have any questions about this Privacy Policy, please contact us at support@foodieful.net.
                    </Typography>
                </Box>
